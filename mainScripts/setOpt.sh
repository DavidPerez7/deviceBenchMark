...
if [ "$opcion" -eq 1 ]; then
    ...
    tsu -c "echo 0 > /sys/devices/system/cpu/cpu$cpu/online"
        echo "CPU$cpu: offline"
    done
    # cluster 1 (freq y governor)
    for cpu in 0 1; do
    tsu -c "echo powersave > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_governor"
    tsu -c "echo 1363000 > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_max_freq"
    tsu -c "echo 1 > /sys/devices/system/cpu/cpu$cpu/online"
        echo "CPU$cpu: powersave, 1363MHz, online"
    done
    # cluster 2 (freq y governor)
    for cpu in 4 5; do
    tsu -c "echo powersave > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_governor"
    tsu -c "echo 1094000 > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_max_freq"
    tsu -c "echo 1 > /sys/devices/system/cpu/cpu$cpu/online"
...
# OPCION 2
    ...
    for cpu in 0 1 2; do
        tsu -c "echo powersave > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_governor"
        tsu -c "echo 1536000 > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_max_freq"
        tsu -c "echo 1 > /sys/devices/system/cpu/cpu$cpu/online"
    ...
    for cpu in 4 5 6; do
        tsu -c "echo powersave > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_governor"
        tsu -c "echo 1401000 > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_max_freq"
        tsu -c "echo 1 > /sys/devices/system/cpu/cpu$cpu/online"
...
# OPCION 3
    ...
    for cpu in 0 1 2 3 4 5 6 7; do
        tsu -c "echo performance > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_governor"
        tsu -c "echo 1804000 > /sys/devices/system/cpu/cpu$cpu/cpufreq/scaling_max_freq"
